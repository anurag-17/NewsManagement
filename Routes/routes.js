...
const { adminlogin, addnews, addblog, viewnews, viewblogs,  deleteblogs, editblogs, editid, editidnews, editnews, deletenews, addcontent, content, updateContent, getcontent, validadmin, optsave, otpvalid, passwordchange, useremail, viewemail, deleteemail, addcareer, viewcareer, deletecareer, careeredit, editcareer, editcontent, updatecontent, deletecontent, getmetadata } = require("../Controller/auth")
...
router.route("/updatecareer").post(editcareer)
