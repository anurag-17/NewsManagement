              ...
              <div className='col-lg-6 col-md-6'>
                <div className='social-menu'>
                  <ul className='socillist'>
                    <li> <a href = "#"><FontAwesomeIcon style={{color:"#4267B2"}} icon={faFacebookF} /></a> </li>
                    ...
                    <li><a target="blank" href='https://www.linkedin.com/company/bullsmart/'><FontAwesomeIcon style = {{color:"#0077b5"}} icon={faLinkedinIn} /></a></li>
                  </ul>
                </div>
              </div>
            </div>
